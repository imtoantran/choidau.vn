...
<div id="popup-login" style="z-index: 1051; display: block;" onkeydown="enterEvent(event)" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" data-backdrop="static" data-max-height="440">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 30px 20px 0px;">
                <form class="form-horizontal"><input type="hidden" name="PHPSESSID" value="ail2uojrvhl6m88j9sqovf8027">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div style="padding-top:10px">
                                <small>
                                    <a href="http://beleza.vn/beleza/requestpass">Quên mật khẩu?</a> Hay chưa có tài khoản, hãy
                                    <a href="http://beleza.vn/beleza/clientsignup">Đăng ký!</a>
                                </small>
                            </div>
            ...
            <div class="modal-footer" id="footer_login" style="padding: 15px 20px 15px;">
                ...
                <!-- imtoantran add login with facebook -->
                <button type="submit"  class="btn blue">Đăng nhâp <i class="m-icon-swapright m-icon-white"></i>
