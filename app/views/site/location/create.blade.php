					...
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="form-group">
							...
							<div class="col-sm-4 col-md-3 col-lg-3 location-wrapper-img">
                                ...
                                <div id="iM_user_slide1" type_insert="insert_one_img" class="single-picture-wrapper imageManager_openModal1 insertMedia" style="position: relative;" data-toggle="modal" data-target="#imageManager_modal">
