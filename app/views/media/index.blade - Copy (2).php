								   ...
								   <form id="fileupload" action="/media-data" method="POST" enctype="multipart/form-data">
									...
									<!--   <div class="media-tab-content">
										   <ul class=" list-unstyled files">
												<li class="col-md-2 in media-item" >
													<img class="img-responsive" src="/upload/2/thumbnails/2/j-4_165x95.jpg" />
													<span><i class="icon-ok-circled2"></i></span>
													<div class="media-tool">
														<a href="#" class="icon-btn-cd btn-delete-img">
												...
												<a href="#">
													<img class="img-responsive" src="/upload/2/thumbnails/2/j-4_165x95.jpg" />
													</a><span><i class="icon-ok-circled2"></i></span>
													<div class="media-tool">
														<a href="#" class="icon-btn-cd btn-delete-img">
															<button class="icon-cancel-circle-2 delete" data-type="{%=file.deleteType%}" data-url="{%=file.deleteUrl%}"{% if (file.deleteWithCredentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
															</button>
										...
										<li class="col-md-2 media-item in">
                                                            
															
																<a href="http://choidau.net/public/upload/files/10943917_514647952011735_1429984673590018334_n%20%281%29.jpg" title="10943917_514647952011735_1429984673590018334_n (1).jpg" download="10943917_514647952011735_1429984673590018334_n (1).jpg" data-gallery="">
																<img class="img-responsive" src="http://choidau.net/public/upload/files/thumbnail/10943917_514647952011735_1429984673590018334_n%20%281%29.jpg"></a>
																<span><i class="icon-ok-circled2"></i></span>
                                                    ...
                                                    <div class="media-tool">
															...
															<a href="#" class="icon-btn-cd btn-delete-img">
																<button class="icon-cancel-circle-2 delete" data-type="DELETE" data-url="/media-data?file=10943917_514647952011735_1429984673590018334_n%20%281%29.jpg">
																</button>
															</a>
															<a href="#" class="icon-btn-cd btn-check-img">
															<i class="icon-ok-circle-1">
                                     ...
                                     <div role="presentation" class="col-md-12 media-list-content">
                                                    ...
                                                    <div>
                                                        <span class="preview">
                                                            {% if (file.thumbnailUrl) { %}
																...
																<img class="img-responsive" src="{%=file.thumbnailUrl%}"></a>
                                                            {% } %}
                                                        </span>
                                                    </div>
