                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
									...
									<span class="photo">
									<img src="{{asset("assets/admin/layout3/img/avatar2.jpg")}}" class="img-circle"
                                         alt="">
									</span>
									<span class="subject">
									<span class="from">
                                ...
                                <li>
                                    <a href="inbox.html?a=view">
									<span class="photo">
									<img src="{{asset("assets/admin/layout3/img/avatar3.jpg")}}" class="img-circle"
                                         alt="">
									</span>
									<span class="subject">
									<span class="from">
                                ...
                                <li>
                                    <a href="inbox.html?a=view">
									<span class="photo">
									<img src="{{asset("assets/admin/layout3/img/avatar1.jpg")}}" class="img-circle"
                                         alt="">
									</span>
									<span class="subject">
									<span class="from">
