...
return array(
	...
	*/
	...
	'settings'              => 'Cài đặt',
	'profile'               => 'Thông tin',
	'user_account_is_not_confirmed'          => 'Tài khoản chưa được xác thực.',
	'user_account_updated'          => 'Tài khoan đã được cập nhật.',
	'user_account_created'          => 'Tài khoản đã được tạo.',
    ...
    'signup' => array(
        ...
        'confirmation_required' => 'Yêu cầu xác nhận',
        'submit' => 'Đăng ký',
    ),

    'login' => array(
        'title' => 'Đăng Ký',
        'desc' => 'Nhập thông tin mô tả',
        'forgot_password' => 'quên mật khẩu',
